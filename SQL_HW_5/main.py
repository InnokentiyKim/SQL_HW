...
def main():
    ...
    clients_db  = Clients(conn)
    clients_db.create_databadb
    clients_db.add_client('Dmitriy', 'Vasilev', 'dmvasil@mail.ru', ['+7 987 902 33 55', '+7 932 822 11 32'])
    clients_db.add_client('Dmitriy', 'Levin', 'Dlevin@ya.ru', ['+7 934 456 52 13'])
    clients_db.add_client('Sergey', 'Demin', 'SDemin@ya.ru', ['+7 913 355 17 19'])
    clients_db.add_client('Ivan', 'Ivanov', 'IvanovI@gmail.com')
    clients_db.add_phone('+7 932 211 12 63', 2)
    clients_db.add_phone('+7 978 434 07 05', 3)
    clients_db.delete_phone(2, 3)
    clients_db.find_client(first_name='Dmitriy', email='dmvasil@mail.ru')
    clients_db.change_clients_info(1, first_name='Grigoriy', email='DGrigory@indox.ru')
    clients_db.add_client('Ivan', 'Ivanov', 'IvanovI_88@gmail.com', ['+7987 902 3355'])
    clients_db.change_clients_info(4, phones=['+7 956 124 78 58', '+7 926 259 62 48'])
    clients_db.show_clients_info(4)
    clients_db.delete_client(3)
    clients_db.delete_phone(4, 7)
    clients_db.delete_all_phones(4)
    clients_db.show_all_clients()
    clients_db.find_client(phone='+79322111263')
    conn.close()
